...
const thresholdStartTime =  moment(aStartTime, 'MMMM Do YYYY, h:mm:ss a').format('MMMM Do YYYY, h:mm:ss a');
const thresholdEndTime =  moment(aEndTime, 'MMMM Do YYYY, h:mm:ss a').format('MMMM Do YYYY, h:mm:ss a');
